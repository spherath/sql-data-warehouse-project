...
product_key |	INT |	Surrogate key linking to the order to product dimension table.|
customer_key |	INT |	Surrogate key linking to the order to customer dimension table.|
...
price |	INT |	The price unit of the product for the line item, in whole currency units (Ex. 25).|
----------------------------------------------------------------------------------------------------------------
